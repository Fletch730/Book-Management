...
<fieldset class="sty" >
  <legend style="text-align:left; font-size:50px; ">UPDATE BOOK DETAILS</legend>
...
Review:
<textarea name="review" rows="20%" cols="100%" value=""><?php echo $row['review']; ?></textarea><br><br>
...
IN Stock:(1- Available /0- Out of Stock)
